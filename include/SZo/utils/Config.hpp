/**
 * @file Config.hpp
 * @brief This file defines the configuration class and related utilities for SZo.
 *
 ...
 *       from older versions of SZo remain compatible with newer versions.
 *       Removing or altering fields could break deserialization or cause
 *       unexpected behavior in applications relying on SZo.
 */

#ifndef SZo_Config_HPP
#define SZo_Config_HPP
 ...
 * - ALGO_INTERP_LORENZO: SZo algorithm (Interpolation with Lorenzo, with tuning).
...
/**
 * @class Config
 * @brief Configuration class for SZo.
 *
 * The Config class stores various parameters and settings used by SZo, such as:
