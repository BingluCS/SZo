...
#ifndef SZo_MEMORYOPS_HPP
#define SZo_MEMORYOPS_HPP
...
// Byte-swap intrinsics for fast endianness conversion
    ...
    #define SZo_HAS_BUILTIN_BSWAP 1
...
#else
    #define SZo_HAS_BUILTIN_BSWAP 0
#endif
