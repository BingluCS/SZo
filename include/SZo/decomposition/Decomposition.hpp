#ifndef SZo_DECOMPOSITION_INTERFACE
#define SZo_DECOMPOSITION_INTERFACE
 ...
 * prediction + quantization). Note: SZo has both Predictor and Decomposition interfaces. You should choose Predictor
...
class DecompositionInterface {
   public:
     ...
     */
    virtual std::tuple<To*, uint64_t> compress(const Config &conf, Ti *data) = 0;
