...
inline void usage() {
    ...
    printf("* examples: \n");
    printf(
        "\tprint_h5repack_args -c szo.conf\n"
        "\t (output: -f UD=32024,0,11,4077060608,16843009,0,33554432,4054449152,1348619730,16818239,257,2147483904,2147483648,16777216)\n");
    printf(
        "\tprint_h5repack_args -r '32024,0,11,4077060608,16843009,0,33554432,4054449152,1348619730,16818239,257,2147483904,2147483648,16777216' -o szo.conf\n");
    exit(0);
}
