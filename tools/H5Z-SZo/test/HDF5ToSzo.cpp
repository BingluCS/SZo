...
int main(int argc, char *argv[]) {
    ...
    if (argc < 2) {
        printf("Test case: HDF5ToSzo [hdf5FilePath]\n");
        printf("Example 1: HDF5ToSzo testdata/x86/testfloat_8_8_128.dat.szo.h5\n");
        printf("Example 2: HDF5ToSzo testdata/x86/testint32_8x8x8.dat.szo.h5\n");
        exit(0);
    }
    ...
    avail = H5Zfilter_avail(H5Z_FILTER_SZo);
    if (!avail)
        printf("szo filter is not yet available after the H5Pget_filter call.\n");
    else
        printf("szo filter is available.\n");
    ...
    printf("....Reading SZo compressed data .....................\n");
    ...
    switch (type_class) {
        ...
        case H5T_INTEGER:
            ...
            break;
        default:
            printf("Error: H5Z-SZo supports only float, double or integers.\n");
            exit(1);
    }
