...
#ifdef _WIN32
#ifdef SZOC_EXPORTS
#define SZOC_API __declspec(dllexport)
#else
#define SZOC_API __declspec(dllimport)
#endif
#else
#define SZOC_API
#endif
...
extern "C" {
#endif
SZOC_API unsigned char *SZ_compress_args(int dataType, void *data, size_t *outSize, int errBoundMode,
                                         double absErrBound, double relBoundRatio, double pwrBoundRatio, size_t r5,
                                         size_t r4, size_t r3, size_t r2, size_t r1);

SZOC_API void *SZ_decompress(int dataType, unsigned char *bytes, size_t byteLength, size_t r5, size_t r4, size_t r3,
                             size_t r2, size_t r1);

SZOC_API void free_buf(void *p);
#ifdef __cplusplus
}
#endif
